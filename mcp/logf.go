...
func (l *Logger) Fatalf(message string, colorCode ...string) {
	l.Log(FATAL, "FATAL", message, colorCode...)
}
func (l *Logger) Errorf(message string, colorCode ...string) {
	l.Log(ERROR, "ERROR", message, colorCode...)
}
func (l *Logger) Warnf(message string, colorCode ...string) {
	l.Log(WARN, "WARN", message, colorCode...)
}
func (l *Logger) Infof(message string, colorCode ...string) {
	l.Log(INFO, "INFO", message, colorCode...)
}
func (l *Logger) Debugf(message string, colorCode ...string) {
	l.Log(DEBUG, "DEBUG", message, colorCode...)
}
func (l *Logger) Tracef(message string, colorCode ...string) {
	l.Log(TRACE, "TRACE", message, colorCode...)
}
