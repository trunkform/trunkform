...
import (
	...
	rubrichandlers "github.com/trunkform/trunkform/trunkform/rubricHandlers"
...
func TestProcessRubric(t *testing.T) {
	tests := []struct {
		...
		{"ci-cd-linting", map[string]*string{
			...
			"lint-implemented":             strPtr("make"),
			"unit-test-implemented":        strPtr("make unit-test"),
			"ci-cd-automation-boilerplate": strPtr("cat ../.github/workflows/trunkform.yml | grep -- 'max-parallel: 1'"),
		...
		{"ci-cd-unit-testing", map[string]*string{
			...
			"unit-test-implemented":        strPtr("make unit-test"),
			"ci-cd-automation-boilerplate": strPtr("cat ../.github/workflows/trunkform.yml | grep -- 'max-parallel: 1'"),
			"ci-cd-linting":                strPtr("cat ../.github/workflows/trunkform.yml | grep -- 'run: make'"),
		...
		{"perf-test", map[string]*string{
			...
			"ci-cd-automation-boilerplate":                   strPtr("cat ../.github/workflows/trunkform.yml | grep -- 'max-parallel: 1'"),
			"ci-cd-linting":                                  strPtr("cat ../.github/workflows/trunkform.yml | grep -- 'run: make'"),
			"ci-cd-unit-testing":                             strPtr("cat ../.github/workflows/trunkform.yml | grep -- 'run: make'"),
			"continuous-integration-iac":                     strPtr("cat ../.github/workflows/trunkform.yml | grep -- 'terragrunt run --all apply'"),
